...
public class ListChestYoutube extends AppCompatActivity {
    // ListView
    ListView lvVideo;
    ...
    String ID_PLAYLIST = "PLLXmeIOBkPXSZPuGx7zBxlWP7KdQQjgHY";
    int REQUEST_VIDEO = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_chest_youtube);

        //Animation
        overridePendingTransition(R.anim.fade_in,R.anim.zoom_out);

        // set Adapter
        lvVideo = findViewById(R.id.lvChestVideo);
        videos = new ArrayList<>();
        adapter = new VideoAdapter(ListChestYoutube.this,R.layout.row_video,videos);
        ...
        lvVideo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ListChestYoutube.this,PlayYoutubeVideo.class);
    ...
    private void getJSON(String url) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListChestYoutube.this, error.toString().trim(), Toast.LENGTH_SHORT).show();
            }
        });
