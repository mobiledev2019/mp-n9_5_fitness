...
public class ListYoutubeExercise extends AppCompatActivity {
    // ListView
    ListView lvVideo;
    ...
    // Youtube API
    public static String API_KEY = "AIzaSyAx-KuBQz2DpXwSDQAbMpOtWri8ZGXqudI";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new VideoAdapter(ListYoutubeExercise.this,R.layout.row_video,videos);
        ...
        lvVideo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ListYoutubeExercise.this,PlayYoutubeVideo.class);
    ...
    private void getJSON(String url) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListYoutubeExercise.this, error.toString().trim(), Toast.LENGTH_SHORT).show();
            }
        });
